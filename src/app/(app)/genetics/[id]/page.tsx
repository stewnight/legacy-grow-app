    ...
    <div className="flex-1 space-y-4 p-4 pt-6 md:p-8">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            {genetic.breeder ? <>Bred by {genetic.breeder}</> : 'Unknown breeder'}
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        {genetic.growProperties?.floweringTime && (
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Flowering Time</CardTitle>
        ...
        {genetic.growProperties?.yield && (
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {genetic.growProperties.yield.min}-{genetic.growProperties.yield.max}{' '}
                ...
                <dl className="space-y-2">
                  ...
                  <div>
                    ...
                    <dd className="text-sm">
                      {formatDate(genetic.createdAt)} by {genetic.createdBy?.name}
                    </dd>
                  </div>
                </dl>
              </CardContent>
                  ...
                  <dl className="space-y-2">
                    {genetic.growProperties.difficulty && (
                      <div>
                        ...
                        <dd className="text-sm capitalize">{genetic.growProperties.difficulty}</dd>
                      </div>
                    )}
                    {genetic.growProperties.environment && (
                      <div>
                        <dt className="text-sm font-medium text-muted-foreground">Environment</dt>
                        <dd className="text-sm capitalize">{genetic.growProperties.environment}</dd>
                      </div>
                    )}
                    {genetic.growProperties.height && (
                      <div>
                        <dt className="text-sm font-medium text-muted-foreground">Height Range</dt>
                        <dd className="text-sm">
                          {genetic.growProperties.height.min}-{genetic.growProperties.height.max}{' '}
                ...
                <Card>
                  ...
                  <CardContent>
                    <dl className="space-y-2">
                      {genetic.properties.thc && (
                        <div>
                          <dt className="text-sm font-medium text-muted-foreground">THC Range</dt>
                          <dd className="text-sm">
                            {genetic.properties.thc.min}% - {genetic.properties.thc.max}%
                          </dd>
                        </div>
                      ...
                      {genetic.properties.cbd && (
                        <div>
                          <dt className="text-sm font-medium text-muted-foreground">CBD Range</dt>
                          <dd className="text-sm">
                            {genetic.properties.cbd.min}% - {genetic.properties.cbd.max}%
                          </dd>
                        </div>
                      )}
                      {genetic.properties.terpenes && (
                        <div>
                          <dt className="text-sm font-medium text-muted-foreground">Terpenes</dt>
                          <dd className="flex flex-wrap gap-1">
                            {genetic.properties.terpenes.map((terpene) => (
                              <Badge key={terpene.name} variant="secondary" className="text-xs">
                                {terpene.name}
                  ...
                  <CardContent>
                    <dl className="space-y-2">
                      {genetic.properties.effects && (
                        <div>
                          <dt className="text-sm font-medium text-muted-foreground">Effects</dt>
                          <dd className="flex flex-wrap gap-1">
                      ...
                      {genetic.properties.flavors && (
                        <div>
                          <dt className="text-sm font-medium text-muted-foreground">Flavors</dt>
                          <dd className="flex flex-wrap gap-1">
              ...
              {genetic.lineage ? (
                <dl className="space-y-2">
                  {genetic.lineage.mother && (
                    <div>
                      <dt className="text-sm font-medium text-muted-foreground">Mother</dt>
                      <dd className="text-sm">{genetic.lineage.mother}</dd>
                    </div>
                  )}
                  {genetic.lineage.father && (
                    <div>
                      <dt className="text-sm font-medium text-muted-foreground">Father</dt>
                  ...
                  {genetic.lineage.hybridRatio && (
                    <div>
                      <dt className="text-sm font-medium text-muted-foreground">Hybrid Ratio</dt>
